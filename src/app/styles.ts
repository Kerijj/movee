export const s = {
  ...
  input: "bg-white/60 backdrop-blur-md border-none rounded-[25px] py-4 px-8 w-full md:w-80 text-[#8E443D] text-sm focus:outline-none focus:ring-2 focus:ring-[#E88E7D]/40 shadow-sm",
  select: "bg-[#E88E7D] text-white border-none rounded-[25px] py-4 px-8 w-full md:w-64 text-sm font-bold cursor-pointer shadow-lg hover:bg-[#d67b6a] transition-colors appearance-none text-center",
  ...
  cardWatched: "bg-[#F7D8C4]", 

  // Текст в карточке
  genreTag: "text-[11px] font-black uppercase tracking-[0.2em] text-[#8E443D]/30 mb-4 block",
  movieTitle: "text-4xl font-black text-[#8E443D] leading-tight mb-4 group-hover:text-[#E88E7D]",
  description: "text-[15px] text-[#8E443D]/70 leading-relaxed font-medium mb-10 line-clamp-4",

  // Футер карточки (Badge + Rating)
  cardFooter: "mt-auto pt-8 flex justify-between items-end border-t border-[#8E443D]/5",
  badgeStack: "flex flex-col gap-2",
  badge: "bg-white/50 backdrop-blur-sm px-4 py-1.5 rounded-full text-[10px] font-black text-[#8E443D] w-fit shadow-sm uppercase",
  ratingGroup: "text-right flex flex-col items-end",
  ratingLabel: "text-[10px] font-black text-[#8E443D]/20 uppercase mb-1",
  ratingValue: "text-6xl font-black text-[#8E443D] italic leading-[0.8]",
